...
const mockIssue = {
  ...
  description:
    "This is a test description that could be quite lengthy and should wrap properly on mobile devices and smaller screens.",
...
describe("Responsive Design Tests", () => {
  describe("IssueCard Component", () => {
    it("should render all content on desktop", () => {
      renderWithProviders(
        <IssueCard issue={mockIssue} onEdit={() => {}} onDelete={() => {}} />,
      );

      expect(
        screen.getByText("Test Issue Title That Might Be Very Long"),
      ).toBeInTheDocument();
      expect(
    ...
    it("should handle empty tags array", () => {
      ...
      renderWithProviders(
        <IssueCard issue={noTagsIssue} onEdit={() => {}} onDelete={() => {}} />,
      );
